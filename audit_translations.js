...
const polishTypoPatterns = [
  { pattern: /jądrowymi/gi, suggestion: 'Check if should be "jądrowymi" vs "jądrowymi"' },
  { pattern: /\s{2,}/g, suggestion: 'Multiple spaces found' },
...
if (issues.length === 0) {
  ...
  console.log('\nTask 4: Issues found - manual review recommended');
}